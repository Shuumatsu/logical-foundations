...
Proof.
  destruct b, c; discriminate || reflexivity.
Qed.
(** [] *)
...
(* FILL IN HERE
Fixpoint rej (n : nat): nat :=
  if ltb 5 n then 5 else rej (n + 1). 
end.
    [] *)
...
Theorem andb_eq_orb :
  ...
  b = c.
Proof.
  intros. destruct b, c; discriminate || reflexivity. 
Qed.
...
Proof. 
  unfold bin_to_nat. reflexivity.
Qed.

Example test_bin_incr5 :
        bin_to_nat (incr (B Z)) = 1 + bin_to_nat (B Z).
Proof. 
  unfold incr. unfold bin_to_nat. reflexivity.
Qed.
