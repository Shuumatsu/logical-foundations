...
Proof.
  split; intros.
    ...
    - induction H.
      + apply ev'_0.
      + apply (ev'_sum 2 n); apply ev'_2 || assumption.
Qed.
(** [] *)
...
Proof.
  intros. induction H0.
    - simpl. assumption.
    - apply IHev. simpl in H. apply evSS_ev in H. assumption.
Qed. 
(** [] *)
...
Proof.
  intros n m p H. apply ev_ev__ev. replace (n + p + (m + p)) with (n + m + (double p)).
